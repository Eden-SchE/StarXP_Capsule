...
#include "MyG4CoinSysAnalysis.hh"
#include "g4root.hh"
#include "Verbose.hh"
...
MyG4CoinSysAnalysis::MyG4CoinSysAnalysis()
{
...
void MyG4CoinSysAnalysis::BeginOfRunAction()
{
    if (!active)
        return;

    if (verbose)
        G4cout << "====>MyG4CoinSysAnalysis::BeginOfRunAction()" << G4endl;
...
void MyG4CoinSysAnalysis::EndOfRunAction()
{
    if (!active)
        return;

    if (verbose)
        G4cout << "====>MyG4CoinSysAnalysis::EndOfRunAction()" << G4endl;
...
void MyG4CoinSysAnalysis::BeginOfEventAction(const G4Event *evt)
{
    if (!active)
        return;

    if (verbose > 1)
        G4cout << "====>MyG4CoinSysAnalysis::BeginOfEventAction()" << G4endl;
...
void MyG4CoinSysAnalysis::EndOfEventAction(const G4Event *)
{
    if (!active)
        return;

    if (verbose > 1)
        G4cout << "====>MyG4CoinSysAnalysis::EndOfEventAction()" << G4endl;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4ClassificationOfNewTrack MyG4CoinSysAnalysis::ClassifyNewTrack(const G4Track *aTrack)
{
    if (!active)
        return fUrgent;

    if (verbose > 2)
        G4cout << "====>MyG4CoinSysAnalysis::ClassifyNewTrack()" << G4endl;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4CoinSysAnalysis::PreTrackingAction(const G4Track *aTrack)
{
    if (!active)
        return;

    if (verbose > 2)
        G4cout << "====>MyG4CoinSysAnalysis::PreTrackingAction()" << G4endl;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4CoinSysAnalysis::PostTrackingAction(const G4Track *aTrack)
{
    if (!active)
        return;

    if (verbose > 2)
        G4cout << "====>MyG4CoinSysAnalysis::PostTrackingAction()" << G4endl;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4CoinSysAnalysis::SteppingAction(const G4Step *aStep)
{
    if (!active)
        return;

    if (verbose > 2)
        G4cout << "====>MyG4CoinSysAnalysis::SteppingAction()" << G4endl;
