...
void MyAnalysisManager::SetOutputInfo(OutputControl ControlOutput) 
{
    ...
    //if (fControlOutput.DetectorName == G4String("CoinSys"))
    //{
    //    delete fMyG4BasedAnalysis;
    //    fMyG4BasedAnalysis = new MyG4CoinSysAnalysis();
    //    G4cout << "Set output template to CoinSys" << G4endl;
    //}
