...
#ifndef _PrimaryCosmicRayElectron_H_
#define _PrimaryCosmicRayElectron_H_
...
class PrimaryCosmicRayElectron: public CosmicRay
{
public:
    PrimaryCosmicRayElectron();
    ~PrimaryCosmicRayElectron();
...
private:
    ...
    G4double mass;
    G4double r;
    G4double solar_modulation;
    G4double Rearth;
    G4double orbit_hight;
    G4double R;
    G4double latitude;
};
